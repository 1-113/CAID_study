...
plt.legend()
plt.savefig('/Volumes/SN770/研究生文件/CAID/figure/预设_背叛控制.png', bbox_inches='tight')
...
plt.legend()
plt.savefig('/Volumes/SN770/研究生文件/CAID/figure/选择节点_背叛控制.png', bbox_inches='tight')
...
plt.legend()
plt.savefig('/Volumes/SN770/研究生文件/CAID/figure/替代节点.png', bbox_inches='tight')
...
plt.savefig('/Volumes/SN770/研究生文件/CAID/figure/Energy_cost.png', bbox_inches='tight')
"""
