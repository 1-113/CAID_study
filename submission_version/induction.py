...
# 绘制图形
plt.figure(1)
pos = nx.spring_layout(G,seed = SEED)  # 为图形设置布局
...
plt.savefig(os.path.join(figure_dir, f'Fig_induction_to_{TARGET_VALUE}.pdf'), format='pdf', dpi=500, bbox_inches='tight', pad_inches=0.1)
...
plt.savefig(os.path.join(figure_dir, 'Fig_induction_chosen_players.pdf'), format='pdf', dpi=500, bbox_inches='tight', pad_inches=0.1)
...
ax.spines['left'].set_bounds(0, ax.get_ylim()[1])    # y轴从0到最大值
ax.spines['bottom'].set_bounds(0, ax.get_xlim()[1])  # x轴从0到最大值
plt.savefig(os.path.join(figure_dir, 'Fig_induction_replaced_players.pdf'), format='pdf', dpi=500, bbox_inches='tight', pad_inches=0.1)
...
ax.spines['left'].set_bounds(0, ax.get_ylim()[1])    # y轴从0到最大值
ax.spines['bottom'].set_bounds(0, ax.get_xlim()[1])  # x轴从0到最大值
plt.savefig(os.path.join(figure_dir, 'Fig_induction_energy_cost.pdf'), format='pdf', dpi=500, bbox_inches='tight', pad_inches=0.1)
"""
