...
plt.legend()
plt.savefig('/Volumes/SN770/研究生文件/CAID/figure/预设_无背叛控制.png', bbox_inches='tight')
...
plt.legend()
plt.savefig('/Volumes/SN770/研究生文件/CAID/figure/选择节点_无背叛控制.png', bbox_inches='tight')
